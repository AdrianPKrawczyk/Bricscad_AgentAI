...
{
    public static class CalculateRpnToolTests
    {
        public static void RunTests()
        {
            ...
            System.Console.WriteLine("Pomyślnie zakończono wszystkie testy CalculateRpnTool.");
        }

        private static void TestGetToolSchema()
        {
            var tool = new CalculateRpnTool();
            var schema = tool.GetToolSchema();
            
            Debug.Assert(schema.Function.Name == "CalculateRpn", "Niewłaściwa nazwa narzędzia");
        ...
        private static void TestCalculationSaveAs()
        {
            ...
            Debug.Assert(AgentMemoryState.Variables.ContainsKey("TestRpnVal"), "Nie zapisano wartości w zmiennych");
            Debug.Assert(AgentMemoryState.Variables["TestRpnVal"] == "50", $"Oczekiwano wartości 50, otrzymano: {AgentMemoryState.Variables["TestRpnVal"]}");
        }
    }
}
