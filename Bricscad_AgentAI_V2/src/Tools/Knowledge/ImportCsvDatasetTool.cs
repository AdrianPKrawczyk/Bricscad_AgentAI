    ...
    public class ImportCsvDatasetTool : IToolV2
    {
            ...
            return new ToolDefinition
            {
                ...
                Function = new FunctionSchema
                {
                    ...
                    Parameters = new ParametersSchema
                    {
                        ...
                        Required = new List<string> { "datasetName", "csvContent", "description", "category" }
                    }
                }
            };
        }
        ...
        public string Execute(Document doc, JObject parameters)
        {
            try
            {
                ...
                return $"SUKCES: Zapisano zestaw danych '{datasetName}' ({jsonArray.Count} rekordów) w kategorii '{category}'.";
            }
            catch (Exception ex)
            {
