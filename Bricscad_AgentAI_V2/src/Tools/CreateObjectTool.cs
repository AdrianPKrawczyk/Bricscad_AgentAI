                ...
                Function = new FunctionSchema
                {
                    ...
                    Parameters = new ParametersSchema
                    {
                        ...
                        Properties = new Dictionary<string, ToolParameter>
                        {
                            ...
                            { "StartPoint", new ToolParameter { Type = "string", Description = "Punkt startowy (X,Y,Z). DOZWOLONY TYLKO dla obiektu Line. ABSOLUTNIE ZABRONIONE dla DBText, MText oraz Circle! Jeśli wstawiasz tekst użyj 'Position', jeśli okrąg użyj 'Center'. Format: 'X,Y,Z'." } },
                            { "EndPoint", new ToolParameter { Type = "string", Description = "Punkt końcowy (x,y,z). Format: 'X,Y,Z'. BEZWZGLĘDNIE BEZ NAWIASÓW." } },
                            { "Center", new ToolParameter { Type = "string", Description = "Punkt środkowy (X,Y,Z). WYMAGANY I DOZWOLONY TYLKO dla obiektu Circle. Absolutnie nie używaj dla innych obiektów. Format: 'X,Y,Z'." } },
                            { "Radius", new ToolParameter { Type = "string", Description = "Promień okręgu." } },
                            { "Position", new ToolParameter { Type = "string", Description = "Pozycja wstawienia. WYMAGANA I DOZWOLONA TYLKO dla tekstów (DBText i MText). ZABRONIONE dla Line oraz Circle. Format: 'X,Y,Z'." } },
