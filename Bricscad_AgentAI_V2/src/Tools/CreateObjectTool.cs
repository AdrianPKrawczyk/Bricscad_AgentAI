                ...
                Function = new FunctionSchema
                {
                    ...
                    Parameters = new ParametersSchema
                    {
                        ...
                        Properties = new Dictionary<string, ToolParameter>
                        {
                            ...
                            { "StartPoint", new ToolParameter { Type = "string", Description = "Punkt startowy (X,Y,Z). DOZWOLONY TYLKO dla obiektu Line. ABSOLUTNIE ZABRONIONE dla DBText oraz MText! Jeśli wstawiasz tekst, MUSISZ użyć parametru 'Position'. Format: 'X,Y,Z'. BEZWZGLĘDNIE BEZ NAWIASÓW." } },
                            ...
                            { "Position", new ToolParameter { Type = "string", Description = "Pozycja wstawienia. WYMAGANA dla DBText i MText. Nie używaj dla linii. Format: 'X,Y,Z'. BEZWZGLĘDNIE BEZ NAWIASÓW." } },
