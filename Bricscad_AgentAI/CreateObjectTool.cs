        ...
        public string Execute(Document doc, string argsJson = "")
        {
            ...
            try
            {
                ...
                using (Transaction tr = db.TransactionManager.StartTransaction())
                {
                    ...
                    // ==========================================
                    // TWORZENIE TEKSTÓW (DBText i MText złączone)
                    // ==========================================
                    ...
                    else if (entityType.Equals("MLeader", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        using (MLeaderStyle mlStyle = (MLeaderStyle)tr.GetObject(db.MLeaderstyle, OpenMode.ForRead)) { finalHeight = mlStyle.TextHeight; }
